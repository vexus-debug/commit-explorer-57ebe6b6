      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          <div className="rounded-2xl overflow-hidden relative">
            <img src={groupImg} alt="Beulah Health Group team on community outreach" className="w-full object-cover aspect-[4/3]" />
            <div className="absolute bottom-4 left-4 right-4 bg-primary/90 backdrop-blur-sm rounded-xl p-4">
              ...
              <p className="text-secondary text-xs mt-1">— {imp.quoteAuthor}</p>
            </div>
          </div>
          <div>
            <span className="text-secondary text-sm font-semibold uppercase tracking-wider">{imp.sectionLabel}</span>
