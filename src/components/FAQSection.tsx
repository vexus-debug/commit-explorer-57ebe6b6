          ...
          <div className="space-y-4 sticky top-24">
            ...
            <div className="bg-section-alt rounded-2xl p-6">
              ...
              <p className="text-section-alt-foreground/70 text-sm mb-3">
                {f.supportDescription} <span className="font-semibold text-secondary">{f.supportPhone}</span> or email us for immediate assistance.
              </p>
              <a href={`mailto:${f.supportEmail}`} className="text-secondary text-sm font-medium hover:underline">
                {f.supportEmail} →
              </a>
            </div>
          </div>
