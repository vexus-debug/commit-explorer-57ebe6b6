    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <span className="text-secondary text-sm font-semibold uppercase tracking-wider">{m.sectionLabel}</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <img src={outreachImage} alt="Community engagement" className="rounded-2xl shadow-lg w-full object-cover aspect-[3/4]" />
            <img src={officeImage} alt="Partnership meeting" className="rounded-2xl shadow-lg w-full object-cover aspect-[3/4] mt-8" />
          </div>
        </div>

        <div className="bg-section-alt rounded-3xl p-8 md:p-14">
          <div className="text-center mb-12">
            <span className="text-secondary text-sm font-semibold uppercase tracking-wider">{m.valuesLabel}</span>
